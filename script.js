...
const cameraParts = [
    ...
    { id: 'shutter-speed', name: 'Shutter Speed' },
    { id: 'af-mf', name: 'AF/MF Button' },
    { id: 'control-wheel', name: 'Control Wheel' },
    { id: 'delete-button', name: 'Delete Button' },
    { id: 'menu-button', name: 'Menu Button' },
    { id: 'camera-roll', name: 'Camera Roll' }
];
